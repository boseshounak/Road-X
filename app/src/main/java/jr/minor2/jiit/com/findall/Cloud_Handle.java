...
public class Cloud_Handle extends AsyncTask implements DialogInterface.OnClickListener {
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        link="https://phpandroid.000webhostapp.com/FindAll/scripts.php";
        if(choice.equals("login")){
            ...
            String vechicle=objects[3].toString();
            ...
            encode=URLEncoder.encode("type")+"="+URLEncoder.encode("dobook")+"&"+
                    ...
                    URLEncoder.encode("vechicle")+"="+URLEncoder.encode(vechicle)+"&"+
