    ...
    protected void onPostExecute(Object o) {
        ...
        if(!read_data.equals("")){
            ...
            if(!read_data.contains("error_message")){
                ...
                Toast.makeText(context,"Server overload plaese try after 7 seconds",Toast.LENGTH_SHORT).show();
            }
        }
        else{
